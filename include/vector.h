...
/**
 * Finds a normal vector to the given vector
 *
 * @param v the vector find a normal of
 * @return normal vector to the given vector (one of two possible)
 */
 ...
 *
 * @param v the vector normalize
 * @return normalized vector
 */
vector_t vec_normalize(vector_t v);

/**
 * Checks if a vector is within a certain area
 * 
 * @param v the vector whose position is being checked
 * @param min minimum vector
 * @param max maximum vector
 * @return true if vector is within the area, false if not
 */
